...
- [Quick Start Guide](quick_start.md) for installation and environment setup.
- [DSL Programming Model](cute_dsl.md) for the DSL programming model.
- [Guides](guides.md) for framework integration, debugging, profiling, autotuning,
  ahead-of-time compilation, and MMA programming guides.
- [API Reference](apis.md) for Basic Data Types, CUDA (Jittable), CuTe, Pipeline, and
  Utilities.
- [Limitations](limitations.md), [Deprecation Policy](deprecation.md), and [FAQs](faqs.md) for support boundaries,
...
refer to the [Quick Start Guide](quick_start.md) section.

## Platform Support

- Linux on x86\_64 and aarch64.
- Python and CUDA Toolkit versions listed in [Quick Start Guide](quick_start.md).
...
- Start with [Quick Start Guide](quick_start.md) to install dependencies and verify the
  environment.
- Read [DSL Programming Model](cute_dsl.md) for the DSL programming model, including JIT functions,
  kernels, static values, control flow, and argument handling.
- Use [Guides](guides.md) for task-focused workflows such as framework integration,
  debugging, profiling, autotuning, AOT compilation, and MMA programming.
- Use [API Reference](apis.md) as the reference for Basic Data Types, CuTe, Pipeline, and
  Utilities.
- Check [Limitations](limitations.md), [Deprecation Policy](deprecation.md), and [FAQs](faqs.md) for support
...
[Deprecation Policy](deprecation.md) policy, API reference, and limitations pages. For known issues
and workarounds, consult [Limitations](limitations.md) and [FAQs](faqs.md).
