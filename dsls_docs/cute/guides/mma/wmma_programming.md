...
TiledMMA, MMA Ops](wmma_programming.md#setting-up-the-tiledmma-mma-ops) for their full constructor parameters, instruction
...
- [Setting up the TiledMMA, MMA Ops](wmma_programming.md#setting-up-the-tiledmma-mma-ops)
  ...
  - [Creating a Warp MMA Op](wmma_programming.md#creating-a-warp-mma-op)
  - [Creating a Tiled MMA](wmma_programming.md#creating-a-tiled-mma)
  - [Spatial tiling with a repeat count](wmma_programming.md#spatial-tiling-with-a-repeat-count)
  - [Custom tile permutation with `permutation_mnk`](wmma_programming.md#custom-tile-permutation-with-permutation-mnk)
...
- [Making Fragments](wmma_programming.md#making-fragments)
  ...
  - [Creating register fragments and `ldmatrix` copy views](wmma_programming.md#creating-register-fragments-and-ldmatrix-copy-views)
  - [Creating SMEM layouts for A and B](wmma_programming.md#creating-smem-layouts-for-a-and-b)
...
- [Beyond Simple Dense MMAs](wmma_programming.md#beyond-simple-dense-mmas)
  ...
  - [Block-scaled MMA](wmma_programming.md#block-scaled-mma)

## [Global Memory (GMEM) to MMA data flow overview](wmma_programming.md#id2)
...
## [Setting up the TiledMMA, MMA Ops](wmma_programming.md#id3)
...
### [Creating a Warp MMA Op](wmma_programming.md#id4)
...
### [Creating a Tiled MMA](wmma_programming.md#id5)
...
### [Spatial tiling with a repeat count](wmma_programming.md#id6)
...
### [Custom tile permutation with `permutation_mnk`](wmma_programming.md#id7)
...
**Why double N?** The atom’s N dimension is only 8 (inst\_N = 8). Without
...
[0t\_mma\_atom.md](https://docs.nvidia.com/cutlass/latest/media/docs/cpp/cute/0t_mma_atom.md). Take a 2x2 tiled MMA
...
## [Partitioning Tensors](wmma_programming.md#id8)
...
- `tCsA: (MMA, MMA_M, MMA_K, PIPE) = (MMA, 4, 2, 4)` — MMA\_M = BM/perm\_M = 128/32 = 4, MMA\_K = BK/perm\_K = 32/16 = 2
- `tCsB: (MMA, MMA_N, MMA_K, PIPE) = (MMA, 4, 2, 4)` — MMA\_N = BN/perm\_N = 128/32 = 4, MMA\_K = BK/perm\_K = 32/16 = 2
- `tCgC: (MMA, MMA_M, MMA_N) = (MMA, 4, 4)` — MMA\_M = 128/32 = 4, MMA\_N = 128/32 = 4
...
The `tCsA` / `tCsB` SMEM partitions are not read directly
...
`ldmatrix` retiling path (see [Making Fragments](wmma_programming.md#making-fragments)).

## [Pre and Post-Conditions for Partitioning](wmma_programming.md#id9)
...
## [Making Fragments](wmma_programming.md#id10)
...
### [Creating register fragments and `ldmatrix` copy views](wmma_programming.md#id11)
...
Continuing the running example from [Partitioning Tensors](wmma_programming.md#partitioning-tensors) (F16
...
### [Creating SMEM layouts for A and B](wmma_programming.md#id12)
...
and the `ldmatrix` copy views described in [Making Fragments](wmma_programming.md#making-fragments).

## [Executing the GEMM (Main Loop)](wmma_programming.md#id13)
...
## [Complete Workflow](wmma_programming.md#id14)
...
## [Beyond Simple Dense MMAs](wmma_programming.md#id15)

The warp MMA DSL supports more complex MMA operations beyond simple dense MMA:

- Block-scaled MMA

### [Block-scaled MMA](wmma_programming.md#id16)
