...
Refer to [Integration with Frameworks](../guides/framework_integration.md) for more details on `from_dlpack`, `mark_layout_dynamic`,
...
Please refer to [Control Flow](dsl_control_flow.md) for more details.
