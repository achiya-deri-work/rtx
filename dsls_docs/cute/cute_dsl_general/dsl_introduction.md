...
- `preferred_smem_carveout`
  ...
  - `None` (default) — Auto calculate the percentage using formula `ceil_div(min_blocks_per_mp * smem * 100, max_smem_per_mp)` when **min\_blocks\_per\_mp** is greater than 1
